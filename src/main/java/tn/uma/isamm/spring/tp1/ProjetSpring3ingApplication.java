...
public class ProjetSpring3ingApplication {
	...
	public static void main(String[] args) {
		...
		Commande cd3 = new Commande(new Date(System.currentTimeMillis() - 3600 * 1000), "Nabeul", c1);
...
//		cd3.setClient(c1);	
		...
		Commande c = commandeDAO.findById(2L).get();
		Commande cc = commandeDAO.findById(3L).get();
		
		
		LigneCommande l1 = new LigneCommande(10, new PK_PROD_CMD(), p3, c);
		LigneCommande l2 = new LigneCommande(15,new PK_PROD_CMD() ,p2, cc);
